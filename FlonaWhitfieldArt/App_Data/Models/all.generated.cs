...
#pragma warning restore 0109
		...
		///<summary>
		/// Exclude From Top Navigation: Tick this you don't  want this page appear in the top navigation
		///</summary>
...
#pragma warning restore 0109
	...
	// Mixin content Type 1078 with alias "introControls"
...
#pragma warning restore 0109
	...
	// Mixin content Type 1079 with alias "titleControls"
...
#pragma warning restore 0109
	...
	// Mixin content Type 1083 with alias "basicContentControls"
	/// <summary>Basic Content Controls</summary>
	public partial interface IBasicContentControls : IPublishedContent
	{
		/// <summary>Content Gird</summary>
		Newtonsoft.Json.Linq.JToken ContentGird { get; }
	}
...
#pragma warning restore 0109
		...
		public Newtonsoft.Json.Linq.JToken ContentGird
		{
			get { return GetContentGird(this); }
		}

		/// <summary>Static getter for Content Gird</summary>
		public static Newtonsoft.Json.Linq.JToken GetContentGird(IBasicContentControls that) { return that.GetPropertyValue<Newtonsoft.Json.Linq.JToken>("contentGird"); }
	}

	// Mixin content Type 1085 with alias "topNavigationControls"
